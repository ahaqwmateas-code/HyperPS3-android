...
public class Application extends android.app.Application
{
    ...
    static boolean should_delay_load() {
        if(gpu_device_name_vk==null) return true;
    ...
    public void onCreate()
    {
        ...
        try {
            ...
            android.util.Log.e("aps3e_java", "GPU probe failed", t);
        }

        Emulator.setup_preload_env(this);
        if(gpu_device_name_vk == null) {
            android.util.Log.w("aps3e_java", "Vulkan GPU unavailable; delaying native load");
        } else if(!should_delay_load()) {
