...
public class Emulator extends aenu.emulator.Emulator
{
	...
	public static synchronized void load_library(){
		if(get!=null) return;
		// Load first.  The previous order left `get` non-null if JNI loading failed,
		// which prevented a clean retry during startup.
