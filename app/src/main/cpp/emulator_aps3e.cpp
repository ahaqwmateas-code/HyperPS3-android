...
#endif
    jclass cls_MetaInfo=env->FindClass("com/hyperps3/emulator/Emulator$MetaInfo");
...
static jobject j_trophy_info_from_dir(JNIEnv* env,jobject self,jstring jreal_path,jstring jvfs_path){
    ...
    jclass cls_GameTrophyInfo=env->FindClass("com/hyperps3/emulator/Emulator$GameTrophyInfo");
    jmethodID mid_GameTrophyInfo_ctor=env->GetMethodID(cls_GameTrophyInfo,"<init>","()V");
    jfieldID fid_GameTrophyInfo_trophies=env->GetFieldID(cls_GameTrophyInfo,"trophies","[Lcom/hyperps3/emulator/Emulator$GameTrophyInfo$TrophyInfo;");
    ...
    jclass cls_TrophyInfo=env->FindClass("com/hyperps3/emulator/Emulator$GameTrophyInfo$TrophyInfo");
...
int register_aps3e_Emulator(JNIEnv* env){
    ...
    static const JNINativeMethod methods[] = {
            ...
            //{ "meta_info_from_iso","(Ljava/lang/String;)Lcom/hyperps3/emulator/Emulator$MetaInfo;",(void*)MetaInfo_from_iso},
            { "meta_info_from_dir","(Ljava/lang/String;)Lcom/hyperps3/emulator/Emulator$MetaInfo;",(void*)j_meta_info_from_dir},

            { "meta_info_from_iso","(ILjava/lang/String;)Lcom/hyperps3/emulator/Emulator$MetaInfo;",(void*)j_meta_info_from_iso},
            ...
            { "trophy_info_from_dir", "(Ljava/lang/String;Ljava/lang/String;)Lcom/hyperps3/emulator/Emulator$GameTrophyInfo;", (void *) j_trophy_info_from_dir},
            { "search_memory", "(Lcom/hyperps3/emulator/Emulator$CheatInfo;)[Lcom/hyperps3/emulator/Emulator$CheatInfo;", (void *) j_search_memory},
            { "set_cheat", "(Lcom/hyperps3/emulator/Emulator$CheatInfo;)V", (void *) j_set_cheat},
            { "get_cheat", "(Lcom/hyperps3/emulator/Emulator$CheatInfo;)V", (void *) j_get_cheat},

            {"camera_frame", "([BIII)V", (void *) j_camera_frame},
    };

    jclass clazz = env->FindClass("com/hyperps3/emulator/Emulator");
