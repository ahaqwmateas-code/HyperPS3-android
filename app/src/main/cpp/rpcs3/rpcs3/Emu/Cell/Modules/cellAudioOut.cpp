...
audio_out_configuration::audio_out_configuration()
{
	...
	const psf::registry sfo = Emu.GetIsoFs()?psf::load_object(fs::file(*Emu.GetIsoFs(),":PS3_GAME/PARAM.SFO"),"PS3_GAME/PARAM.SFO"):psf::load_object(Emu.GetSfoDir(true) + "/PARAM.SFO");
