...
auto _##func(Args&&... args)->decltype(func(args...)){ \
   ...
   if constexpr(std::is_same_v<decltype(func(args...)),void>){ \
    ...
    save_msg(std::format("/storage/emulated/0/Android/data/com.hyperps3.emulator/files/aps3e/logs/{}.txt",#func),#func,static_cast<int64_t>(meminfo_gpu_mem_usage_kb())-n_##func)   ; \
    }else{                                        \
